...
def get_imagenet_dataloader(rank, worldsize, dataset='imagenet', batch_size=128, num_workers=16, is_instance=False):
    """
    Data Loader for imagenet
    """
    if dataset == 'imagenet':
...
if __name__ == '__main__':
    train_loader, test_loader, train_sampler, test_sampler = get_imagenet_dataloader(rank=1, worldsize=2)
